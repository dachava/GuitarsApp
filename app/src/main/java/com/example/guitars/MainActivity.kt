...
import com.example.guitars.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeRegister() {
        ...
        auth.createUserWithEmailAndPassword(email,pass) //Metodo que ya existe para authentication
    ...
    private fun makeLogin() {
        ...
        auth.signInWithEmailAndPassword(email,pass) //Metodo que ya existe para hacer login
